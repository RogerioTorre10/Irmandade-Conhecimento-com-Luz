// Substituir TODO o conteúdo do /assets/js/section-intro.js
...
  function getText(el) {
    // Prioriza data-text, depois textContent
...
    // *** BLOCO DE FALLBACK REMOVIDO ***
    // Agora confiamos que o jornada-loader.js injetou os elementos.
    // Se eles não existirem (el1, el2 ou btn são null),
    // o script falhará com um erro, o que é o comportamento correto
    // indicando um problema de carregamento de HTML.
    // *** FIM DO BLOCO DE FALLBACK REMOVIDO ***

    if (!el1 || !el2 || !btn) {
        console.error('[section-intro.js] ERROR: Critical elements missing after load. Check section-intro.html.');
        return; 
    }
...
            continue;
          }
          // O texto é puxado do data-text (que deve vir do HTML)
