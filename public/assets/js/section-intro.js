(function () {
  ...
  const handler = async (evt) => {
    window.JCIntro.state.HANDLER_COUNT++;
    console.log(`[JCIntro] Handler disparado (${window.JCIntro.state.HANDLER_COUNT}x):`, evt?.detail);
  ...
  window.JCIntro.destroy = () => {
    ...
    window.JCIntro.state.HANDLER_COUNT = 0;
    window.JCIntro.state.TYPING_COUNT = 0;
