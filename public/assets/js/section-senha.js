...
const HOME_PAGE = '/';
const HIDE = 'hidden';
const INITIAL_TYPING_DELAY_MS = 12000; // Aumentado para dar mais tempo
const TRANSITION_SRC = '/assets/img/filme-senha-confirmada.mp4';
const TRANSITION_TIMEOUT_MS = 8000;
const TTS_FALLBACK_DELAY_MS = 3000; // Aumentado para fallback de TTS
...
async function waitForTypingBridge(maxMs = 5000) { // Aumentado
const t0 = Date.now();
