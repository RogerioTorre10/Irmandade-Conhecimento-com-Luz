...
function ensureFinalSectionExists() {
  ...
  // Se já existe no HTML, só usa e sai
  if (finalEl) {
    log('section-final já existe no HTML, usando versão existente.');
    return finalEl;
  }
